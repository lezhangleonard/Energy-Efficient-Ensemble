...
models = {'alexnet': AlexNet, 'lenet': LeNet}
selectedModel = models[model_name]

# get dataloaders
train_loader, valid_loader, test_loader, input_shape, input_channels, out_classes = get_dataset(ds=dataset, batch_size=batch_size, train_ratio=train_ratio)
...
prune_step = 8          # number of steps to gradually prune each learner
criterion = torch.nn.CrossEntropyLoss()
# create an ensemble
